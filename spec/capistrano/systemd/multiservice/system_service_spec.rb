...
describe Capistrano::Systemd::MultiService::SystemService do
  subject { Capistrano::Systemd::MultiService::SystemService.new("example") }
  ...
  describe "with config/systemd/example1.service.erb" do
    subject { Capistrano::Systemd::MultiService::SystemService.new("example1") }
  ...
  describe "with config/systemd/example2.service.erb, example2@.service.erb" do
    subject { Capistrano::Systemd::MultiService::SystemService.new("example2") }
  ...
  describe "with config/systemd/example3@.service.erb" do
    subject { Capistrano::Systemd::MultiService::SystemService.new("example3") }
  ...
  describe "without config file" do
    subject { Capistrano::Systemd::MultiService::SystemService.new("example4") }
